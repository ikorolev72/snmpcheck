...
WriteFile( $outfile, "NE name,NE IP,Result,Type,Master/Slave,QL/PL,CLK Entry,Slot,Card type,Port,Priority,SSM usage,CLK status,Lockout status,QL,Forced SSM,Selected,Equipment clock status\n" ) ;
######### header of worker output table 
