...
WriteFile( $outfile, "NE name,NE type,IP,Result,QoS mode,Number of queues,active profile,profile number,profile status,entry,Classification,Priority,Internal priority\n" ) ;
######### header of worker output table 
