...
WriteFile( $outfile, "NE name,IP,NE type,Result,interface,BR,VLAN ID,CoS,IP address,Netmask,Usage,NE port usage,Connect NMS port to NMS,Mgmt bandwidth limit,M-plane Cos\n" ) ;
######### header of worker output table 
