...
my $export_param="gbemtu='$ip_param->{gbemtu}' gbemtuallow='$ip_param->{gbemtuallow}' femtu='$ip_param->{femtu}' femtuallow='$ip_param->{femtuallow}'";
WriteFile( $outfile, "NE name,NE IP,Operation,Result\n" ) ;
######### header of worker output table 
